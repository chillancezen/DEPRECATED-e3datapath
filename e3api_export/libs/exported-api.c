...
DECLARE_E3_API(e3_exported_api41)={
...
DECLARE_E3_API(e3_exported_api47)={
	...
	.args_desc={
		{.type=e3_arg_type_uint16_t,.behavior=e3_arg_behavior_input,.len=0},
		{.type=e3_arg_type_uint8_t_ptr,.behavior=e3_arg_behavior_output,.len=704},
		{.type=e3_arg_type_none,.behavior=e3_arg_behavior_none,.len=0},
	},
};
	...
	uint8_t * arg1)
{
	...
	e3_type real_args[MAX_ARGUMENT_SUPPORTED];
	struct e3_api_client      * client=reference_e3_api_client();
	struct e3_api_declaration * api=search_e3_api_by_name("leaf_api_delete_elan_fwd_entry");
	void                      * output_list[MAX_ARGUMENT_SUPPORTED+1];
	_(client);
	_(api);
	real_args[0]=cast_to_e3_type(arg0);
	...
	uint32_t arg4)
{
	...
	e3_type real_args[MAX_ARGUMENT_SUPPORTED];
	struct e3_api_client      * client=reference_e3_api_client();
	struct e3_api_declaration * api=search_e3_api_by_name("leaf_api_set_elan_fwd_entry");
	void                      * output_list[MAX_ARGUMENT_SUPPORTED+1];
	_(client);
	_(api);
	real_args[0]=cast_to_e3_type(arg0);
	...
	uint16_t arg0)
{
	...
	e3_type real_args[MAX_ARGUMENT_SUPPORTED];
	struct e3_api_client      * client=reference_e3_api_client();
	struct e3_api_declaration * api=search_e3_api_by_name("leaf_api_reset_e_lan_multicast_fwd_entry");
	void                      * output_list[MAX_ARGUMENT_SUPPORTED+1];
	_(client);
	_(api);
	real_args[0]=cast_to_e3_type(arg0);
	...
	uint32_t arg2)
{
	...
	e3_type real_args[MAX_ARGUMENT_SUPPORTED];
	struct e3_api_client      * client=reference_e3_api_client();
	struct e3_api_declaration * api=search_e3_api_by_name("leaf_api_set_e_lan_multicast_fwd_entry");
	void                      * output_list[MAX_ARGUMENT_SUPPORTED+1];
	_(client);
	_(api);
	real_args[0]=cast_to_e3_type(arg0);
	...
	uint8_t * arg0)
{
	...
	e3_type real_args[MAX_ARGUMENT_SUPPORTED];
	struct e3_api_client      * client=reference_e3_api_client();
	struct e3_api_declaration * api=search_e3_api_by_name("infra_api_list_nodes");
	void                      * output_list[MAX_ARGUMENT_SUPPORTED+1];
	_(client);
	_(api);
	real_args[0]=cast_to_e3_type(arg0);
	...
	uint8_t * arg1)
{
	...
	e3_type real_args[MAX_ARGUMENT_SUPPORTED];
	struct e3_api_client      * client=reference_e3_api_client();
	struct e3_api_declaration * api=search_e3_api_by_name("infra_api_get_node");
	void                      * output_list[MAX_ARGUMENT_SUPPORTED+1];
	_(client);
	_(api);
	real_args[0]=cast_to_e3_type(arg0);

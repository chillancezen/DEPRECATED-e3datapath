...
#define TASK_PRIORITY_LOG_INIT 0x0
#define TASK_PRIORITY_HIGH 0x1
#define TASK_PRIORITY_SYSTEM_INIT TASK_PRIORITY_HIGH
#define TASK_PRIORITY_RESOURCE_INIT (TASK_PRIORITY_HIGH+0x1)
#define TASK_PTIORITY_LOW (TASK_PRIORITY_RESOURCE_INIT+1000)
